(define (domain cascading-rg-problem-domain)
 ...
 :parameters (?at - node ?to - node)
 :precondition (and (has-improper-vpn-firewall-configuration ?at) (has-vulnerability-cve-2018-0296 ?at) (has-connected ?at ?to))
 :effect (and (has-access-to-network ?to)))
 ...
 :parameters (?at - node ?to - node)
 :precondition (and (has-connected ?at ?to) (has-access-to-network ?at) (has-access-to-plc-port-1132-tcp ?to) (has-vulnerability-cve-2017-9312 ?to) (has-exploit-improperly-implemented-fields-in-stack ?to) (has-allen-bradley-l30erms-safety-devices-v30-and-earlier ?to))
