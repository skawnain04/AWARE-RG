(define (domain cascading-rg-problem-domain)
 ...
 :parameters (?at - node ?to - node)
 :precondition (and (has-vulnerability-cve-2017-9312 ?to) (has-exploit-improperly-implemented-fields-in-stack ?to) (has-allen-bradley-l30erms-safety-devices-v30-and-earlier ?to))
