(define (domain cascading-rg-problem-domain)
 ...
 :precondition (and (has-connected ?at ?to) (has-mitre-ics-execution))
 :effect (and (has-access-to-network ?to)))
 (:action exploits-vulnerability-cve-2018-0296
 :parameters (?at - node ?to - node)
 :precondition (and (has-connected ?at ?to) (has-mitre-ics-initial-access))
 :effect (and (has-access-to-network ?to)))
 ...
 :parameters (?at - node ?to - node)
 :precondition (and (has-connected ?at ?to) (has-access-to-network ?at) (has-access-to-plc-port-1132-tcp ?to) (has-mitre-ics-execution))
