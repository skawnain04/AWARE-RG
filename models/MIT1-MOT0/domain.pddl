(define (domain cascading-rg-problem-domain)
 ...
 :parameters (?at - node)
 :precondition (and (has-vulnerability-cve-2019-0575 ?at) (has-mitre-ics-lateral-movement))
 :effect (and (has-done-remote-code-execution ?at)))
 (:action exploits-vulnerability-cve-2019-0584
 :parameters (?at - node)
 :precondition (and (has-vulnerability-cve-2019-0584 ?at) (has-mitre-ics-lateral-movement))
 :effect (and (has-done-remote-code-execution ?at)))
 (:action exploits-vulnerability-cve-2018-0538
 :parameters (?at - node)
 :precondition (and (has-vulnerability-cve-2018-0538 ?at) (has-mitre-ics-lateral-movement))
 :effect (and (has-done-remote-code-execution ?at)))
 (:action gain-network-access-from-remote-code-execution
 :parameters (?at - node ?to - node)
 :precondition (and (has-done-remote-code-execution ?at) (has-mitre-ics-lateral-movement))
 :effect (and (has-mitre-ics-lateral-movement)))
 (:action exploits-vulnerability-cve-2018-0296
 :parameters (?at - node ?to - node)
 :precondition (and (has-improper-vpn-firewall-configuration ?at) (has-vulnerability-cve-2018-0296 ?at) (has-mitre-ics-lateral-movement))
 :effect (and (has-mitre-ics-lateral-movement)))
 ...
 :parameters (?at - node ?to - node)
 :precondition (and (has-vulnerability-cve-2017-9312 ?to) (has-exploit-improperly-implemented-fields-in-stack ?to) (has-allen-bradley-l30erms-safety-devices-v30-and-earlier ?to) (has-mitre-ics-lateral-movement))
